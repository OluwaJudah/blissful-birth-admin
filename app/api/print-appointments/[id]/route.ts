    ...
    const appointmentStr = appointments.reduce((acc, appointment) => {
      ...
      return (
        ...
        `<tr>
              ...
              <td class="border p-2">${
                remindersMap[appointment.pregnancyWeeks] ?? ""
              }</td>
            </tr>`
      );
    }, "");
